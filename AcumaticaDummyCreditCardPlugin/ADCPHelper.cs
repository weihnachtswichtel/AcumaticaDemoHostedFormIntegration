...
namespace AcumaticaDummyCreditCardPlugin
{
    public static class ADCPHelper
    {
        ...
        public static Dictionary<CCTranType, string> MapReverseTranType = new Dictionary<CCTranType, string>
        {
            {CCTranType.AuthorizeOnly, "Authorization"},
            {CCTranType.AuthorizeAndCapture, "Capture"},
            {CCTranType.PriorAuthorizedCapture, "Capture"},
            {CCTranType.CaptureOnly, "Capture"},
            {CCTranType.Void, "Void"},
            {CCTranType.VoidOrCredit, "Refund"},
            {CCTranType.Credit, "Credit"}
        };
